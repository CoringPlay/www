<?php
$db->Query("SELECT * FROM payments WHERE status = '1' ORDER BY id DESC");
$all_rows = $db->NumRows();
$per_page = 50;
...
$db->Query("SELECT * FROM payments WHERE status = '1' ORDER BY id DESC LIMIT $start,$per_page");
if($all_rows > 0){
